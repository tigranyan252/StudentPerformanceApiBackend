    ...
    public partial class InitialPostgreMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeacherSubjectGroupAssignmentId = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    TeacherId = table.Column<int>(type: "integer", nullable: false),
                    SubjectId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_TeacherSubjectGroupAssignments_TeacherSubjectGr~",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_TeacherSubjectGroupAssignments_TeacherSubjectGr~",
                        column: x => x.TeacherSubjectGroupAssignmentId,
                        principalTable: "TeacherSubjectGroupAssignments",
                        principalColumn: "TeacherSubjectGroupAssignmentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Grades_TeacherSubjectGroupAssignments_TeacherSubjectGroupAs~",
                        column: x => x.TeacherSubjectGroupAssignmentId,
                        principalTable: "TeacherSubjectGroupAssignments",
                        principalColumn: "TeacherSubjectGroupAssignmentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            // ИЗМЕНЕНИЕ: Исправлен синтаксис WHERE для PostgreSQL
            migrationBuilder.CreateIndex(
                name: "IX_Grades_StudentId_AssignmentId",
                table: "Grades",
                columns: new[] { "StudentId", "AssignmentId" },
                unique: true,
                filter: "\"AssignmentId\" IS NOT NULL"); // ИЗМЕНЕНИЕ ЗДЕСЬ (двойные кавычки вместо квадратных скобок)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherSubjectGroupAssignments_TeacherId_SubjectId_GroupId_~",
                table: "TeacherSubjectGroupAssignments",
